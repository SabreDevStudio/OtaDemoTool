define([
  ...
  /**
   * @ngdoc function
   * @name otademoToolApp.controller:AboutCtrl
   * @description
   * # AboutCtrl
   * Controller of the otademoToolApp
   */
  angular.module('otademoToolApp.controllers.CreateReservationCtrl', ['otademoToolApp.services.ArrayUtils', 'otademoToolApp.services.MessagingServices'])
    .constant('')
